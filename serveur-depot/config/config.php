...
define("EMAIL_PASSWORDRESET_SUBJECT", "Password reset for serveur de dépot");
...
define("EMAIL_VERIFICATION_FROM", "berte.cedric@gmail.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Cédric Berte");
define("EMAIL_VERIFICATION_SUBJECT", "Account activation for serveur de depot");
define("EMAIL_CONFIRMATION_SUBJECT", "[esirem] /!\ CONFIRMATION REQUISE /!\ :validation de depot de fichier");
define("EMAIL_CONFIRMATION_FINALE_SUBJECT", "[esirem] confirmation de depot de fichier");
