...
define("COOKIE_SECRET_KEY", "8ih45gsf*2HGF98HFçèdfj");
...
define("EMAIL_SMTP_HOST", 'ssl://smtp.gmail.com');
define("EMAIL_SMTP_AUTH", true);
define("EMAIL_SMTP_USERNAME", "serveur.depot@gmail.com");
define("EMAIL_SMTP_PASSWORD", "bertedenche");
define("EMAIL_SMTP_PORT", 465);
define("EMAIL_SMTP_ENCRYPTION", 'ssl');
...
define("EMAIL_PASSWORDRESET_FROM", "berte.cedric@gmail.com");
define("EMAIL_PASSWORDRESET_FROM_NAME", "Cédric Berte");
define("EMAIL_PASSWORDRESET_SUBJECT", "Réinitialisation du mot de passe pour le serveur de dépôt de l'ESIREM");
define("EMAIL_PASSWORDRESET_CONTENT", "Cliquez sur ce lien pour réinitialisez votre mot de passe:");

/**
 * Configuration for: verification email data
 * Set the absolute URL to register.php, necessary for email verification links
 */
define("EMAIL_VERIFICATION_URL", "http://localhost/serveur-depot/register.php");
define("EMAIL_VERIFICATION_FROM", "serveur.depot@gmail.com");
define("EMAIL_VERIFICATION_FROM_NAME", "Serveur de dépôt");
define("EMAIL_VERIFICATION_SUBJECT", "Activation de compte pour le serveur de depot de l'ESIREM");
define("EMAIL_CONFIRMATION_SUBJECT", "[ESIREM] /!\ CONFIRMATION REQUISE /!\ : validation de dépôt de fichier.");
define("EMAIL_CONFIRMATION_FINALE_SUBJECT", "[ESIREM] Confirmation de dépôt de fichier.");
define("EMAIL_VERIFICATION_CONTENT", "Cliquez sur ce lien pour activer votre compte :");
